#!/usr/bin/env python3
"""Import Batch 153 - Afghan Universities"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch153.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 153 Import Complete!")
    print(f"{'='*70}")
