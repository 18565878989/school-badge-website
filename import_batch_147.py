#!/usr/bin/env python3
"""Import Batch 147 - Asian Universities (Underrepresented Countries Batch 2)"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch147.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 147 Import Complete!")
    print(f"{'='*70}")
