...
TRANSLATIONS = {
    ...
    'en': {
        ...
        'active': 'Active',
        'ai_helper': 'Hello! I am the School Badge AI Assistant 🎓',
        'all': 'All',
        'close': 'Close',
        'comment': 'Comment',
        ...
        'connect_with_alumni': 'Connect with global alumni, share your school stories',
        ...
        'deep_search_desc': 'Describe the school you want in natural language',
        'deep_search_placeholder': 'Describe the school you are looking for...',
        'deep_search_title': 'AI Deep Search',
        'discussion': 'Discussion',
        'edit': 'Edit',
        'enter_code': 'Enter verification code',
        'enter_phone': 'Enter phone number',
        'enter_social': 'Enter Social',
        ...
        'get_code': 'Get Code',
        'hot_schools': 'Popular Schools',
        'hot_topics': 'Trending Topics',
        'latest': 'Latest',
        'likes': 'Likes',
        'loading': 'Loading...',
        'login_first': 'Please login first',
        'my_likes_subtitle': 'Save schools you like, view anytime',
        'my_likes_title': 'My Likes',
        'news': 'News',
        'no_likes_desc': 'Start exploring universities worldwide!',
        'no_likes_yet': 'No liked schools yet',
        'other_login_methods': 'Other Login Methods',
        'page_title_deep_search': 'AI Deep Search - School Badge Collection',
        'page_title_home': 'School Badge Collection',
        'page_title_login': 'Login - School Badge Collection',
        'page_title_register': 'Register - School Badge Collection',
        'page_title_social': 'Social - School Badge Collection',
        'passwords_not_match': 'Passwords do not match',
        'phone_login': 'Phone Login',
        'phone_optional': 'Phone (optional)',
        'phone_placeholder': 'Optional, for password recovery',
        'please_login_to_post': 'Please login to post',
        'post_failed': 'Failed to post',
        'post_placeholder': 'Share your thoughts, experiences or questions...',
        ...
        'sent_wait': 'Sent ({}s)',
        'share': 'Share',
        'share_and_discover': 'Share & Discover',
        'social': 'Social',
        'third_party_not_configured': 'Third-party login not configured. Contact admin.',
        'title_too_short': 'Title must be at least 5 characters',
        'topic_title_placeholder': 'Topic title',
        'total': '',
        'total_schools': 'Total Schools',
        'trending': 'Trending',
        'try_say': 'Please describe the school you are looking for, for example:',
        'views': 'Views',
        'views_count': '{} views',
        'visitor': 'Visitor',
    ...
    'ja': {
        ...
        'active': '活跃',
        'ai_helper': '您好！我是校徽网AI助手 🎓',
        'all': '全部',
        'close': '关闭',
        'comment': '评论',
        'comment_placeholder': '写下你的回复...',
        'comments': '评论',
        'confirm_password': '确认密码',
        'connect_with_alumni': '与全球校友连接，分享你的学校故事，发现更多精彩校徽',
        'content_too_short': '内容至少10个字符',
        'copied': '已复制!',
        'copy_link': '复制链接',
        ...
        'deep_search_placeholder': '描述您想找的学校...',
        'deep_search_title': 'AI 深度搜索',
        'discussion': '讨论',
        'edit': '编辑',
        'enter_code': '请输入验证码',
        'enter_phone': '请输入手机号',
        'enter_social': '进入社交版块',
        'enter_to_send': '按 Enter 发送，Shift + Enter 换行',
        'error_404': '页面不存在',
        'error_500': '服务器错误',
        'explore_more': '探索更多',
        'explore_schools': '探索学校',
        'follow': '关注',
        'following': '已关注',
        ...
        'loading': '加载中...',
        'login_first': '请先登录',
        'my_likes_subtitle': '收藏您喜欢的学校，随时查看',
        'my_likes_title': '我的收藏',
        'news': '资讯',
        'no_likes_desc': '开始探索世界各地的大学校徽，收藏您喜欢的学校吧！',
        'no_likes_yet': '还没有收藏任何学校',
        'other_login_methods': '其他登录方式',
        'page_title_deep_search': 'AI 深度搜索 - 校徽网',
        'page_title_home': '校徽网 - School Badge Collection',
        'page_title_login': '登录 - 校徽网',
        'page_title_register': '注册 - 校徽网',
        'page_title_social': '社交 - 校徽网',
        'passwords_not_match': '两次输入的密码不一致',
        'phone_login': '手机号登录',
        'phone_optional': '手机号（可选）',
        'phone_placeholder': '选填，方便找回密码',
        'please_login_to_post': '请先登录后再发布',
        'post_failed': '发布失败',
        'post_placeholder': '分享你的想法、经验或问题...',
        'post_success': '发布成功！',
        'publish_post': '发布',
        'question': '问答',
        'quick_login': '快速登录',
        ...
        'sent_wait': '已发送 ({}s)',
        'share': '分享',
        'share_and_discover': '分享 & 发现',
        'social': '社交',
        'third_party_not_configured': '第三方登录配置未完成，请联系管理员配置API密钥',
        'title_too_short': '标题至少5个字符',
        'topic_title_placeholder': '话题标题',
        'total': '共',
        'total_schools': '学校总数',
        'trending': '热门',
        'try_say': '请用自然语言描述您想找的学校，例如：',
        'views': '浏览',
        'views_count': '{} 次浏览',
        'visitor': '访客',
        'your_status': '你的状态',
