#!/usr/bin/env python3
"""Import Batch 150 - Russia and South Korea Universities"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch150.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 150 Import Complete!")
    print(f"{'='*70}")
