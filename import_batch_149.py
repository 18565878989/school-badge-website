#!/usr/bin/env python3
"""Import Batch 149 - Underrepresented Asian Countries"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch149.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 149 Import Complete!")
    print(f"{'='*70}")
