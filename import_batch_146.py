#!/usr/bin/env python3
"""Import Batch 146 - Asian Universities (Underrepresented Countries)"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch146.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 146 Import Complete!")
    print(f"{'='*70}")
