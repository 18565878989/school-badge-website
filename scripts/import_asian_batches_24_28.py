#!/usr/bin/env python3
"""
Import script for Asian Schools Batches 24-28
"""
...
DB_PATH = 'database.db'
BATCHES = [
    ('data/asian_schools_batch24.json', 24),
    ('data/asian_schools_batch25.json', 25),
    ('data/asian_schools_batch26.json', 26),
    ('data/asian_schools_batch27.json', 27),
    ('data/asian_schools_batch28.json', 28),
]
