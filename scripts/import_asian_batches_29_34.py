#!/usr/bin/env python3
"""
Import script for Asian Schools Batches 29-34
"""
...
DB_PATH = 'database.db'
BATCHES = [
    ('data/asian_schools_batch29.json', 29),
    ('data/asian_schools_batch30.json', 30),
    ('data/asian_schools_batch31.json', 31),
    ('data/asian_schools_batch32.json', 32),
    ('data/asian_schools_batch33.json', 33),
    ('data/asian_schools_batch34.json', 34),
]
