#!/usr/bin/env python3
"""
Import script for Asian Schools Batch 13
"""
...
DB_PATH = 'database.db'
BATCH_FILE = 'data/asian_schools_batch13.json'

def import_batch():
    """Import Asian schools from batch 13 JSON file."""
    ...
    cursor.execute("SELECT COUNT(*) FROM schools WHERE region = 'Europe'")
    total_europe = cursor.fetchone()[0]
    ...
    print(f"  - Total European schools: {total_europe}")
