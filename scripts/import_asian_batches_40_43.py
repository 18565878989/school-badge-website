#!/usr/bin/env python3
"""
Import script for Asian Schools Batches 40-44
"""
...
DB_PATH = 'database.db'
BATCHES = [
    ('data/asian_schools_batch40.json', 40),
    ('data/asian_schools_batch41.json', 41),
    ('data/asian_schools_batch42.json', 42),
    ('data/asian_schools_batch43.json', 43),
]
