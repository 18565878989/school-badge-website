#!/usr/bin/env python3
"""Import Batch 151 - Asian Universities"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch151.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 151 Import Complete!")
    print(f"{'='*70}")
