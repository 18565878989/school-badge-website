#!/usr/bin/env python3
"""Import Batch 148 - Central Asian and Caucasus Universities (Reissue with new IDs)"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch148.json")
...
def import_batch():
    ...
    cursor.execute("SELECT MAX(id) FROM schools WHERE region='Asia'")
    max_id = cursor.fetchone()[0]
    
    conn.close()
    
    print(f"\n{'='*70}")
    print(f"✅ Batch 148 Import Complete!")
    print(f"{'='*70}")
