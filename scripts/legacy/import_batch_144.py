#!/usr/bin/env python3
"""Import Batch 144 - Asian Universities (More Underrepresented Countries)"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch144.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 144 Import Complete!")
    print(f"{'='*70}")
