#!/usr/bin/env python3
"""Import Batch 154 - Uzbek Universities"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch154.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 154 Import Complete!")
    print(f"{'='*70}")
