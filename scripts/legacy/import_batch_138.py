#!/usr/bin/env python3
"""Import Batch 138 - Central Asia, South Asia, and Middle East Universities"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch138.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 138 Import Complete!")
    print(f"{'='*70}")
