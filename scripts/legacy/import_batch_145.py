#!/usr/bin/env python3
"""Import Batch 145 - Final batch to complete 21 schools"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch145.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 145 Import Complete!")
    print(f"{'='*70}")
