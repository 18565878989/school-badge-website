#!/usr/bin/env python3
"""Import Batch 139 - Southeast Asia and East Asia Universities"""
...
BATCH_FILE = os.path.expanduser("~/.openclaw/workspace/school-badge-website/data/asian_schools_batch139.json")
...
def import_batch():
    ...
    print(f"\n{'='*70}")
    print(f"✅ Batch 139 Import Complete!")
    print(f"{'='*70}")
